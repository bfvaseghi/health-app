...
export function MetricPanel({
  ...
  return (
    <section className="tl-section record-sheet" aria-label={definition.label}>
      ...
      <div className="tl-section-head" style={{ marginTop: 14 }}>
        ...
        <span className="tl-meta">{recorded.length ? `${recorded.length} readings` : "not recorded"}</span>
      </div>
      <Tide
        data={series}
