...
export function WaterTracker({ date, value, updateDaily }: {
  date: string;
  value: number | null;
  ...
  return <div className="water-tracker">
    <div className="tl-row">
      ...
      <span className="tl-row-copy"><b>Water</b><small role="status">{value == null ? "Not logged" : value >= 1000 ? `${Number((value / 1000).toFixed(2))} L today` : `${value} mL today`}</small></span>
