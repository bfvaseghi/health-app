...
const paths: Record<string, ReactNode> = {
  ...
  caffeine: <><path d="M4 8h13v7a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5V8ZM17 9h2a3 3 0 0 1 0 6h-2M7 3v2M11 2v3M15 3v2" /></>,
  clock: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></>,
  water: <path d="M12 3C9 7 5 11 5 15a7 7 0 0 0 14 0c0-4-4-8-7-12Z" />,
  baseline: <><path d="M3 18h18M6 18v-6M12 18V8M18 18V4" /><path d="M3 21h18" opacity=".4" /></>,
  calendar: <><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M7 3v4M17 3v4M3 11h18" /></>,
  compare: <><path d="M3 7h18M3 17h18M7 3v8M17 13v8" /><circle cx="7" cy="7" r="2" /><circle cx="17" cy="17" r="2" /></>,
